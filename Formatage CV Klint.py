...
def page_formatage_cv():
    ...
    with col_import:
        st.markdown("<div class='section-header'>1) Importer votre CV</div>", unsafe_allow_html=True)
    ...
    with col_download:
        st.markdown("<div class='section-header'>3) Télécharger le CV Klint</div>", unsafe_allow_html=True)
...
def page_service_2():
    """
    Page de Service 2 (vide - en preview).
    """
    st.title("Service 2 - Preview")

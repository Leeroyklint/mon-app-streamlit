...
def page_chat():
    ...
    # Zone de saisie avec formulaire pour soumettre par Entrée ou clic sur l'icône
    with st.form("chat_form", clear_on_submit=True):
        # Utilisation de deux colonnes pour aligner le champ de saisie et l'icône sur une même ligne
